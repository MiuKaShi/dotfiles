...
class AliyunLPic(LPic):
    ...
    @property
    def web_url(self):
        return "https://oss.console.aliyun.com/bucket/{}/{}/object".format(
            self.cloud["Region"], self.cloud["Bucket"]
        )
    ...
    def list(self, prefix):
        ...
        return [
            obj.key
            for obj in sorted(
                [obj for obj in ret.object_list], key=lambda o: -o.last_modified
            )
        ]
