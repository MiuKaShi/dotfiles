...
-- Setup for nvim-cmp.
utils.safe_require({'cmp', 'lspkind', 'nvim-autopairs.completion.cmp'},
 function(cmp, lspkind, cmp_autopairs)
...
utils.safe_require('telescope', function(telescope)
    ...
    telescope.setup{
        ...
        pickers = {
            ...
            diagnostics = {theme = theme, initial_mode = 'normal'},
            lsp_references = {
                theme = 'cursor',
                initial_mode = 'normal',
                layout_config = {width = 0.8, height = 0.4}
            },
            lsp_code_actions = {theme = 'cursor', initial_mode = 'normal'}
        }
    }
end)
...
utils.safe_require('nvim-tree', function(tree)
    local tree_bind_callback = require('nvim-tree.config').nvim_tree_callback
    tree.setup({
        disable_netrw = true,
        hijack_netrw = true,
        open_on_setup = false,
