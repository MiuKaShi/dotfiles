...
M.commands = function(opts)
    opts = opts or {}
    utils.safe_require({'telescope.builtin', 'plenary.context_manager'},
     function(_, context_manager)
         ...
         if #history_lines > max_line then
             history_lines = vim.list_slice(history_lines,
                              #history_lines - max_line, #history_lines)
         end
             ...
             finder = finders.new_table{
                 results = (function()
                     ...
                     table.sort(commands, function(a, b)
                         return utils.index_of(history_lines, a.name, cmp) >
                                 utils.index_of(history_lines, b.name, cmp)
                     end)
                 ...
                 entry_maker = opts.entry_maker or
                  make_entry.gen_from_commands(opts)
             },
