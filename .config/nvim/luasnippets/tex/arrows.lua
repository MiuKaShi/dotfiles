...
autosnips = {
    ...
    s({ trig = '<->', wordTrig = false, name = 'leftrightarrow <->' }, { t '\\leftrightarrow ' }, { condition = tex.in_mathzone }),
    s({ trig = '->', wordTrig = false, name = 'rightarrow -->' }, { t '\\longrightarrow ' }, { condition = tex.in_mathzone }),
    ...
    s({ trig = 'iff', name = 'if and only if <=>', wordTrig = false }, { t '\\iff ' }, { condition = tex.in_mathzone }),
}
