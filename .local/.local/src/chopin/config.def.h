...
static const struct OpenRule open_rules[] = {
    ...
    {"text/css"                                                                  ,"nvim"                      ,0},
    {"text/rtf"                                                                  ,"wps"                       ,0}, // doc
    {"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"         ,"wps"                       ,0},
    {"application/vnd.openxmlformats-officedocument.wordprocessingml.document"   ,"wps"                       ,0},
    {"application/vnd.openxmlformats-officedocument.presentationml.presentation" ,"wps"                       ,0},
    {"application/msword"                                                        ,"wps"                       ,0},
    {"application/vnd.ms-excel"                                                  ,"wps"                       ,0},
    {"application/vnd.ms-outlook"                                                ,"wps"                       ,0},
    {"application/vnd.ms-powerpoint"                                             ,"wps"                       ,0},
    {"application/vnd.ms-project"                                                ,"wps"                       ,0},
    {"application/vnd.visio"                                                     ,"wps"                       ,0},
