static struct Config config = {
	...
	.font = "monospace:size=12,NotoColorEmoji:pixelsize=22",

	/* colors */
	.background_color = "#FFFFFF",
	.foreground_color = "#2E3436",
	.selbackground_color = "#89B482",
	.selforeground_color = "#FFFFFF",
	.separator_color = "#CDC7C2",
	.border_color = "#89B482",

	/* sizes in pixels */
	.width_pixels = 300,        /* minimum width of a menu */
	.height_pixels = 60,        /* height of a single menu item */
